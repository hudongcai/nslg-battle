...
app.get('/download/local-helper', (req, res) => {
  const filePath = path.join(__dirname, 'downloads', 'zhenwu-local-helper-setup-202607121623.exe');
  ...
  res.setHeader('Content-Disposition', 'attachment; filename="zhenwu-local-helper-setup-202607121623.exe"');
